  ...
  <div class="layout_container">
    ...
    <div class="layout_slider" :class="{fold: LayOutSettingStore.fold ? true : false}">
        ...
        <el-scrollbar class="layout_scrollbar">
            <!-- 菜单组件 -->
            <!-- collapse:折叠 -->
            <el-menu :default-active="$route.path"   background-color="#001529" text-color="white" :collapse="LayOutSettingStore.fold" mode="vertical">
                ...
                <!-- 根据路由动态生成菜单 -->
                <Menu  :menu_list="userStore.menuRoutes" :isCollapse="LayOutSettingStore.fold"></Menu>
            </el-menu>
        </el-scrollbar>
    </div>
    <!-- 顶部导航 -->
